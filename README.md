...
Пароли от некоторых уже созданных пользователей: 
логин Momo - пароль momo
логин Miki - пароль miki
Или для проверки можно создать нового пользователя и подписаться на кого-то
___
